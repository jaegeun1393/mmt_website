...
<div className="py-10 bg-white md:py-16">
    <div className="px-10 mx-auto max-w-7xl md:px-16">
        ...
        <form className="grid max-w-3xl gap-4 mx-auto sm:grid-cols-2">
            <div>
                <label for="first-name" className="inline-block mb-2 text-sm font-medium text-gray-500 sm:text-base">First name</label>
            ...
            <div>
                <label for="last-name" className="inline-block mb-2 text-sm font-medium text-gray-500 sm:text-base">Last name</label>
            ...
            <div className="sm:col-span-2">
                <label for="company" className="inline-block mb-2 text-sm font-medium text-gray-500 sm:text-base">Company</label>
            ...
            <div className="sm:col-span-2">
                <label for="email" className="inline-block mb-2 text-sm font-medium text-gray-500 sm:text-base">Email</label>
            ...
            <div className="sm:col-span-2">
                <label for="subject" className="inline-block mb-2 text-sm font-medium text-gray-500 sm:text-base">Subject</label>
            ...
            <div className="sm:col-span-2">
                <label for="message" className="inline-block mb-2 text-sm font-medium text-gray-500 sm:text-base">Message</label>
