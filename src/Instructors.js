        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div className="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-10">
                    ...
                    <p className="text-gray-400">Team member as of 2015
                </p></div>
            ...
            <div className="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-10">
                    <img className="w-32 h-32 mb-6 rounded-full" src="https://cdn.devdojo.com/images/june2021/headshotguy.jpg" />
                    <h2 className="text-lg font-medium">Mike Smith</h2>
                    <p className="font-medium text-blue-500">CTO and Co-Founder</p>
                    <p className="text-gray-400">Team member as of 2015
                </p></div>
            ...
            <div className="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-10">
                    ...
                    <p className="text-gray-400">Team member as of 2016
                </p></div>
            ...
            <div className="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-10">
                    <img className="w-32 h-32 mb-6 rounded-full" src="https://cdn.devdojo.com/images/june2021/female-headshot-2.jpg" />
                    <h2 className="text-lg font-medium">Sandra Mitchell</h2>
                    <p className="font-medium text-blue-500">Lead Designer</p>
                    <p className="text-gray-400">Team member as of 2017
                </p></div>
            ...
            <div className="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-10">
                    <img className="w-32 h-32 mb-6 rounded-full" src="https://cdn.devdojo.com/images/june2021/headshot-female.jpg" />
                    <h2 className="text-lg font-medium">Kelly Rogers</h2>
                    <p className="font-medium text-blue-500">Designer</p>
                    <p className="text-gray-400">Team member as of 2018
                </p></div>
            ...
            <div className="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-10">
                    <img className="w-32 h-32 mb-6 rounded-full" src="https://cdn.devdojo.com/images/june2021/headshotf2.jpg" />
                    <h2 className="text-lg font-medium">Sarah Neilson</h2>
                    <p className="font-medium text-blue-500">Designer</p>
                    <p className="text-gray-400">Team member as of 2018
                </p></div>
