...
class PaymentReport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      table_data: [{ description: "Website design", quantity: 300, price: 12 }],
      num_row: 0,
      total_price: 0,
      addrow_show: "block",
      subtotal1: 0,
  ...
  preset() {
    ...
    for (let i = 0; i < full_length; i++) {
      ...
      td1.className = "pl-4 py-2 inputStyle";
  ...
  async autocal_total() {
    ...
    for (let i = 0; i < this.state.num_row; i++) {
      var sub_price =
        document.getElementById(i + "_price").value *
        document.getElementById(i + "_quantity").value;
      f_sub_p += sub_price;
    }
                ...
                <div className="">
                  ...
                  <div className="container">
                    <table className="w-full sm:bg-white rounded-lg overflow-hidden">
                      ...
                      <tfoot>
                        <tr className="total" id="subTotal"></tr>
