    ...
    <div className="max-w-5xl px-10 py-10 mx-auto xl:px-0">
        <ul className="flex flex-wrap -mx-2 overflow-hidden">
            <li className="w-full px-2 my-2 overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3">
                <a href="#_">
                    <div className="relative flex items-end justify-center mx-2 overflow-hidden bg-gray-300 rounded-lg group h-96">
                        <img src="https://cdn.devdojo.com/images/may2021/tails-blog-1.jpg" className="absolute object-cover object-center w-full h-full transition duration-300 ease-out transform scale-100 group-hover:scale-105" />
            ...
            <li className="w-full px-2 my-2 overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3">
                <a href="#_">
                    <div className="relative flex items-end justify-center mx-2 overflow-hidden bg-gray-300 rounded-lg group h-96">
                        <img src="https://cdn.devdojo.com/images/may2021/tails-blog-2.jpg" className="absolute object-cover object-center w-full h-full transition duration-300 ease-out transform scale-100 group-hover:scale-105" />
            ...
            <li className="w-full px-2 my-2 overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3">
                <a href="#_">
                    <div className="relative flex items-end justify-center mx-2 overflow-hidden bg-gray-300 rounded-lg group h-96">
                        <img src="https://cdn.devdojo.com/images/may2021/tails-blog-3.jpg" className="absolute object-cover object-center w-full h-full transition duration-300 ease-out transform scale-100 group-hover:scale-105" />
                        <div className="absolute z-10 w-full h-full bg-gradient-to-b from-transparent to-black opacity-60"></div>
                        <div className="relative z-20 p-5 text-left">
                            <span className="relative inline-block px-3 py-1 -ml-1 text-xs tracking-wide text-white uppercase">
